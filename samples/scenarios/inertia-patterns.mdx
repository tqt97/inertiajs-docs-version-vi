...
description: "Tám scenario thực chiến giúp ghép các capability Inertia.js v3 thành pattern hoàn chỉnh: search, dashboard, modal form, optimistic toggle, upload, polling, infinite list và external API."
---
