...
description: "Xây Product Index React/TypeScript với Inertia v3: URL-driven filters, debounce search, partial reload, deferred stats, prefetch navigation, optimistic toggle và pagination."
---
