...
description: "Reference CRUD tập trung Frontend với Laravel, React, TypeScript và Inertia.js v3: filter URL, partial reload, deferred props, prefetch, optimistic update, form state, validation và UX production-ready."
---
