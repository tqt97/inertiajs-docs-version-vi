...
description: "Mẫu search, filter và pagination với Inertia.js: URL làm source of truth, debounce, preserveState, replace và partial reload để giảm query thừa."
---
