---
title: Gộp props
description: "Inertia ghi đè prop cùng tên khi reload page. Tuy nhiên đôi khi bạn cần merge dữ liệu mới với dữ liệu hiện có, ví dụ nút \"tải thêm\" cho kết quả phân trang…"
---
