---
title: Giao thức
description: "Trang này đặc tả Inertia protocol: wire contract chính xác giữa Inertia client và server của bạn. Hãy đọc trang cách hoạt động trước để có cái nhìn tổng quan."
---
