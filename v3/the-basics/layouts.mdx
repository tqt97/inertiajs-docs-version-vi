---
title: Layouts
description: "Hầu hết ứng dụng chia sẻ các phần tử UI chung giữa nhiều trang như thanh điều hướng chính, sidebar hoặc footer. Layout component cho phép bạn định nghĩa UI…"
---
