...
description: "Bước đầu khi cài Inertia là cấu hình server-side framework. Inertia duy trì server-side adapter chính thức cho Laravel. Với framework khác, xem community…"
---
