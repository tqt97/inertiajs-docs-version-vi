...
Bạn có thể dùng chức năng [dữ liệu dùng chung](/v2/data-props/shared-data) của Inertia để tự động gửi `csrf_token` trong mỗi response.
...
Bài dịch này được đối chiếu từ [tài liệu Inertia.js v2 chính thức](https://inertiajs.com/docs/v2/security/csrf-protection). Nếu có khác biệt do phiên bản hoặc cập nhật mới, hãy ưu tiên tài liệu chính thức làm nguồn tham chiếu.
