---
title: Response
description: "Tạo response Inertia rất đơn giản. Hãy gọi phương thức Inertia::render() trong controller hoặc route, truyền tên page component JavaScript cần render cùng…"
---
