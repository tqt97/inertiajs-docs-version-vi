---
title: Gộp props
description: "Inertia ghi đè các prop cùng tên khi tải lại một trang. Tuy nhiên, trong một số trường hợp bạn cần gộp dữ liệu mới với dữ liệu hiện có, chẳng hạn khi triển…"
---
